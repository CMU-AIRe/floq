...
from utils.networks_feature_norm import ActorVectorField, Value, CriticVectorField, CriticResVectorField




class FloQFeatureNormAgent(flax.struct.PyTreeNode):
    ...
    def critic_loss(self, batch,  grad_params, rng,):
        ...
        if self.config['training_type'] == 'mc':
            target_returns = batch['mc_returns'] #(batch_size,)
...
def get_config():
    config = ml_collections.ConfigDict(
        dict(
            agent_name='floqfeaturenorm',  # Agent name.
